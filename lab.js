...
favoriteThings["show"] = "Obi-Won-Kenobi"
...
favoriteThings["Ready Player One"]
...
function greeting( obj ) {
  ...
  const {titile, firstName, lastName} = obj
...
const felix = new cat('felix', 5, 'black')
...
class Wizard {
  consturctor (name, age, favoriteSpell) {
    this.name
    this.age
    this.favoriteSpell
  }
...
const maige = new Wizard('Maige', 329, 'Comit Azure, Azuuurrreee')
...
class phone {
  consturnctor(brand, model, storage, color, price) {
    this.brand = brand
    this.model = model
...
const myFirstVehicle = new Vehicle(5, 'black', 50000)
...
const myFirstMotorcycle = new Motorcycle(1, 'black', 1000, 'harley', true)
...
const myFirstBoat = new Boat(50, 'grey and black', 0, 'The House', 'yacht', true)
